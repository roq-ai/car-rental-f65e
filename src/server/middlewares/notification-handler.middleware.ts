...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'ReservationCreated.create': {
    roles: ['administrator', 'vehicle-owner', 'end-user', 'reservation-manager'],
    key: 'reservationId',
    tenantPath: [],
    userPath: [],
  },
  'VehicleStatusUpdated.update': {
  ...
  'PaymentReceived.create': {
    roles: ['administrator', 'reservation-manager'],
    key: 'paymentId',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['administrator', 'vehicle-owner', 'end-user', 'reservation-manager'];
